...
lead_reader_agent = Agent(
    ...
    instructions=[
        ...
        "  - The DYNAMIC_FIELDS the user specified (e.g. restaurant_name, city — whatever they chose)",
        "Do NOT include any other columns (email, website, status, language, etc.) unless the user explicitly asked for them.",
