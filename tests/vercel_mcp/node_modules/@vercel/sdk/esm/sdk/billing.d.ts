...
export declare class Billing extends ClientSDK {
     ...
     */
    listBillingCharges(request: ListBillingChargesRequest, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    listContractCommitments(request: ListContractCommitmentsRequest, options?: RequestOptions): Promise<void>;
}
